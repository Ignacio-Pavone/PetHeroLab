    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 login-sec">
                <form class="register-owner-form" action="" method="POST">
                    <div class=" form-group">
                        <label for="inputMail" class="text-uppercase">Mail</label>
                        <input type="text" name="mail" class="form-control" placeholder="example@mail.com" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="inputEdad" class="text-uppercase">Edad</label>
                    ...
                    <form class="login-form">
                        ...
                        <div class="form-check">
                            <button type="submit" class="btn btn-login float-right" onclick="">Register as
                                Owner</button>
                        </div>
