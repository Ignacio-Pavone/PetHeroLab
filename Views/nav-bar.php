    ...
    <ul class="navbar-nav ml-auto">
        ...
        if (Session::IsLogged()) {
            if (Session::getType() == "owner") { ?>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo FRONT_ROOT . "Owner/showChangePassword"; ?>">Modificar
                        Contraseña</a>
                </li>
            <?php } else {
                ?>
                <button type="button" style="margin-right:20px"
                        class="hovertext btn btn-info text-dark position-relative" data-hover="Tu Calificacion">
                    Calificacion
                ...
                <li class="nav-item">
                    <a class="nav-link"
                       href="<?php echo FRONT_ROOT . 'Auth/showdisponibilityView/' . $user->getFullName(); ?>">Modificar
                        Disponibilidad</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo FRONT_ROOT . "Guardian/showChangePassword"; ?>">Modificar
                        Contraseña</a>
                </li>
            <?php } ?>
            <li class="nav-item">
        ...
        <?php } else { ?>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo FRONT_ROOT . "Home/showownerRegister" ?>">Registrarse como
                    Dueño</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo FRONT_ROOT . "Home/showguardianRegister" ?>">Registrarse como
                    Guardian</a>
            </li>
        <?php } ?>
    </ul>
