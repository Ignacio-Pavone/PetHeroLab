...
<section class="login-block">
    <main class="py-5">
        ...
        <tbody align="center">
            <tr>
                <input type="hidden" name="guardianEmail"  class="form-control form-control-ml" value = <?php echo $user->getEmail()?>>
                <td><?php echo $user->getFullName(); ?></td>
                <td><input type="date" name="fechaInicio" id="initDate" min="<?php echo date('Y-m-d') ?>"></td>
                <td><input type="date" name="fechaFin" id="finishDate" min="<?php echo date('Y-m-d') ?>"></td>
