...
<section class="login-block" style="height:100vh;">
    ...
    <div class="row">
            <div class="col-md-4 login-sec">
                ...
                <hr>
                <form class="register-guardian-form" action="<?php echo FRONT_ROOT . "Duenio/registerDuenio" ?>"
                    method="POST">
                    ...
                    <div class="col-lg-12 input-group mb-3">
                        ...
                        <input type="email" class="form-control" placeholder="example@mail.com" name="email" aria-label="Username"
                    ...
                    <div class="col-lg-12 input-group mb-3">
                        ...
                        <input type="password" class="form-control" placeholder="******" name="password" aria-label="Username"
                        aria-describedby="basic-addon1" required>
                    </div>
                    ...
                    <div class="form-check">
                        ...
                        onclick="">Registrarse como Dueño</button>
                    </div>
